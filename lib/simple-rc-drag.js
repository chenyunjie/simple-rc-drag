var Nr = function(P, p) {
  return Nr = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(O, a) {
    O.__proto__ = a;
  } || function(O, a) {
    for (var v in a)
...
function Ht() {
  ...
  function he(n, c, E) {
    ...
    if (n && n.defaultProps)
      for (D in F = n.defaultProps, F)
        T[D] === void 0 && (T[D] = F[D]);
    return { $$typeof: P, type: n, key: M, ref: W, props: T, _owner: re.current };
  }
  function Ce(n, c) {
  ...
  function ae(n, c, E, D, T) {
    ...
    if (W)
      return W = n, T = T(W), n = D === "" ? "." + te(W, 0) : D, se(T) ? (E = "", n != null && (E = n.replace(Te, "$&/") + "/"), ae(T, c, E, "", function(X) {
        return X;
      })) : T != null && (Oe(T) && (T = Ce(T, E + (!T.key || W && W.key === T.key ? "" : ("" + T.key).replace(Te, "$&/") + "/") + n)), c.push(T)), 1;
    if (W = 0, D = D === "" ? "." : D + ":", se(n))
      ...
      for (n = A.call(n), F = 0; !(M = n.next()).done; )
        M = M.value, A = D + te(M, F++), W += ae(M, c, E, A, T);
    else if (M === "object")
  ...
  return C.Children = { map: Q, forEach: function(n, c, E) {
    ...
    var D = ie({}, n.props), T = n.key, M = n.ref, W = n._owner;
    if (c != null) {
      if (c.ref !== void 0 && (M = c.ref, W = re.current), c.key !== void 0 && (T = "" + c.key), n.type && n.type.defaultProps)
    ...
    return { $$typeof: P, type: n.type, key: T, ref: M, props: D, _owner: W };
      ...
      function Re(e, r, o, i, s) {
        ...
        if ($e(e))
          ...
          if (typeof Wr == "function") {
            ...
            for (var Nt = Wr.call(st), ct, Ut = 0; !(ct = Nt.next()).done; )
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, s), s.default;
      ...
      function u(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === y || e === R || ae || e === k || e === L || e === z || te || e === ge || Oe || Be || Te || typeof e == "object" && e !== null && (e.$$typeof === ie || e.$$typeof === J || e.$$typeof === _ || e.$$typeof === h || e.$$typeof === N || e.$$typeof === t || e.getModuleId !== void 0));
      }
      function l(e, r) {
...
function Gt() {
  ...
  function k(R, _, h) {
    var N, L = {}, z = null, J = null;
    h !== void 0 && (z = "" + h), _.key !== void 0 && (z = "" + _.key), _.ref !== void 0 && (J = _.ref);
    for (N in _)
      a.call(_, N) && !y.hasOwnProperty(N) && (L[N] = _[N]);
    if (R && R.defaultProps)
...
function Kt() {
  return vt || (vt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Oe(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === a || t === y || he || t === v || t === h || t === N || pe || t === J || se || G || re || typeof t == "object" && t !== null && (t.$$typeof === z || t.$$typeof === L || t.$$typeof === k || t.$$typeof === R || t.$$typeof === _ || t.$$typeof === Ce || t.getModuleId !== void 0));
    }
    function Be(t, u, l) {
      var f = t.displayName;
      if (f)
    ...
    function ir(t, u) {
      {
        ...
        or[l] = !0;
        var f = "";
        t && t._owner && t._owner !== Ne.current && (f = " It was passed a child from " + te(t._owner.type) + "."), me(t), U('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', l, f), me(null);
      }
    }
    function ur(t, u) {
      {
...
var Jt = ["u", "d", "l", "r", "lu", "ru", "rd", "ld"], yt = 50, ht = 50, Qt = function(P) {
  ...
  return Object.defineProperty(p.prototype, "componentDidMount", {
    ...
    writable: !0,
    value: function() {
      var O = this, a = this.props, v = a.anchorBorderColor, y = v === void 0 ? "#666666" : v, k = a.anchorBorderWidth, R = k === void 0 ? 1 : k, _ = a.anchorSize, h = _ === void 0 ? 6 : _, N = a.anchorColor, L = N === void 0 ? "#ffffff" : N, z = "solid ".concat(R, "px ").concat(y), J = this.props, ie = J.background, ge = ie === void 0 ? "rgba(243,255,226,.8)" : ie, ne = J.containerStyle, ue = ne === void 0 ? {} : ne, U = {
        background: ge,
