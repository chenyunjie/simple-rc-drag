...
var yt = ["u", "d", "l", "r", "lu", "ru", "rd", "ld"], ht = 50, mt = 50, Qt = function(P) {
  ...
  function p(T) {
    ...
    return Object.defineProperty(a, "isMouseDown", {
      ...
      writable: !0,
      value: function(v) {
        a.startX = v.clientX, a.startY = v.clientY;
        var y = v.target.dataset.key;
        y && yt.includes(y) ? a.isMouseDownOnDrag(v.target) && (v.preventDefault(), a.isMouseDown = !0, a.dragDirection = y) : a.isMouseDownOnDrag(v.target) && (v.preventDefault(), a.isMouseDown = !0, a.element && (a.currentX = a.element.parentElement.offsetLeft, a.currentY = a.element.parentElement.offsetTop));
      }
      ...
      value: function(v) {
        ...
        if (a.isMouseDown) {
          if (v.preventDefault(), a.dragDirection)
            a.transform(y, g);
          else if (a.element) {
      ...
      writable: !0,
      value: function(v) {
        a.isMouseDown = !1, a.element && (a.currentX = a.element.parentElement.offsetLeft, a.currentY = a.element.parentElement.offsetTop, a.width = a.element.parentElement.clientWidth, a.height = a.element.parentElement.clientHeight), a.dragDirection = "";
      }
