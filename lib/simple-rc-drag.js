var Nr = function(k, v) {
  return Nr = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(l, i) {
    ...
    for (var w in i)
      Object.prototype.hasOwnProperty.call(i, w) && (l[w] = i[w]);
  }, Nr(k, v);
};
function Vt(k, v) {
...
var yr = function() {
  return yr = Object.assign || function(v) {
    for (var l, i = 1, w = arguments.length; i < w; i++) {
      l = arguments[i];
      for (var y in l)
...
var Yr = { exports: {} }, Ge = {}, mr = { exports: {} }, O = {};
/**
 * @license React
...
function zt() {
  ...
  function ne(n, c, E) {
    this.props = n, this.context = c, this.refs = ge, this.updater = E || G;
  }
  ...
  var se = Array.isArray, K = Object.prototype.hasOwnProperty, re = { current: null }, de = { key: !0, ref: !0, __self: !0, __source: !0 };
  function he(n, c, E) {
    var D, S = {}, M = null, W = null;
    if (c != null)
      for (D in c.ref !== void 0 && (W = c.ref), c.key !== void 0 && (M = "" + c.key), c)
        K.call(c, D) && !de.hasOwnProperty(D) && (S[D] = c[D]);
    var F = arguments.length - 2;
    if (F === 1)
      S.children = E;
    else if (1 < F) {
      for (var A = Array(F), J = 0; J < F; J++)
        A[J] = arguments[J + 2];
      S.children = A;
    }
    if (n && n.defaultProps)
  ...
  var Oe = /\/+/g;
  function te(n, c) {
    return typeof n == "object" && n !== null && n.key != null ? Ve("" + n.key) : c.toString(36);
  }
  function ae(n, c, E, D, S) {
    ...
    if (W)
      return W = n, S = S(W), n = D === "" ? "." + te(W, 0) : D, se(S) ? (E = "", n != null && (E = n.replace(Oe, "$&/") + "/"), ae(S, c, E, "", function(J) {
        return J;
  ...
  var h = { current: null }, pe = { transition: null }, Se = { ReactCurrentDispatcher: h, ReactCurrentBatchConfig: pe, ReactCurrentOwner: re };
  return O.Children = { map: Q, forEach: function(n, c, E) {
    ...
    return n;
  } }, O.Component = ne, O.Fragment = l, O.Profiler = w, O.PureComponent = Y, O.StrictMode = i, O.Suspense = _, O.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Se, O.cloneElement = function(n, c, E) {
    if (n == null)
    ...
    if (c != null) {
      ...
      for (A in c)
        K.call(c, A) && !de.hasOwnProperty(A) && (D[A] = c[A] === void 0 && F !== void 0 ? F[A] : c[A]);
    }
  ...
  }, O.createElement = he, O.createFactory = function(n) {
...
function Ht() {
  return dt || (dt = 1, function(k, v) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      var l = "18.2.0", i = Symbol.for("react.element"), w = Symbol.for("react.portal"), y = Symbol.for("react.fragment"), T = Symbol.for("react.strict_mode"), R = Symbol.for("react.profiler"), _ = Symbol.for("react.provider"), g = Symbol.for("react.context"), N = Symbol.for("react.forward_ref"), L = Symbol.for("react.suspense"), H = Symbol.for("react.suspense_list"), G = Symbol.for("react.memo"), ie = Symbol.for("react.lazy"), ge = Symbol.for("react.offscreen"), ne = Symbol.iterator, ue = "@@iterator";
      function Y(e) {
      ...
      var Te = !1, Ve = !1, Oe = !1, te = !1, ae = !1, Q = {
      ...
      var be = J.prototype = new A();
      be.constructor = J, E(be, S.prototype), be.isPureReactComponent = !0;
      function gr() {
        var e = {
          current: null
        };
      ...
      function er(e, r) {
        var a = function() {
          Ze || (Ze = !0, h("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
      ...
      function Er(e, r, a) {
        ...
        if (r != null) {
          Be(r) && (p = r.ref, rr(r)), _e(r) && (ke(r.key), m = "" + r.key), b = r.__self === void 0 ? null : r.__self, j = r.__source === void 0 ? null : r.__source;
          for (o in r)
      ...
      function wr(e, r, a) {
        ...
        if (r != null) {
          Be(r) && (p = r.ref, $ = re.current), _e(r) && (ke(r.key), m = "" + r.key);
          var U;
      ...
      function Re(e, r, a, o, s) {
        ...
        if (p) {
          var b = e, j = s(b), $ = o === "" ? tr + Ae(b, 0) : o;
          if ($e(j)) {
            var U = "";
            $ != null && (U = ye($) + "/"), Re(j, r, U, "", function(Ut) {
              return Ut;
            });
          } else
            j != null && (Ee(j) && (j.key && (!b || b.key !== j.key) && ke(j.key), j = Rr(
              j,
              a + (j.key && (!b || b.key !== j.key) ? ye("" + j.key) + "/" : "") + $
            )), r.push(j));
          return 1;
        }
        var V, z, X = 0, ee = o === "" ? tr : o + Cr;
        if ($e(e))
          for (var vr = 0; vr < e.length; vr++)
            V = e[vr], z = ee + Ae(V, vr), X += Re(V, r, a, z, s);
        else {
          var Wr = Y(e);
          if (typeof Wr == "function") {
            ...
            for (var Nt = Wr.call(st), ct, Yt = 0; !(ct = Nt.next()).done; )
              V = ct.value, z = ee + Ae(V, Yt++), X += Re(V, r, a, z, s);
          } else if (m === "object") {
            var lt = String(e);
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, s), s.default;
      ...
      function u(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === y || e === R || ae || e === T || e === L || e === H || te || e === ge || Te || Ve || Oe || typeof e == "object" && e !== null && (e.$$typeof === ie || e.$$typeof === G || e.$$typeof === _ || e.$$typeof === g || e.$$typeof === N || e.$$typeof === t || e.getModuleId !== void 0));
      }
      function f(e, r) {
                ...
                if ($ !== 1 || U !== 1)
                  do
                    if ($--, U--, U < 0 || b[$] !== j[U]) {
                      var V = `
` + b[$].replace(" at new ", " at ");
                      return e.displayName && V.includes("<anonymous>") && (V = V.replace("<anonymous>", e.displayName)), typeof e == "function" && cr.set(e, V), V;
                    }
                  while ($ >= 1 && U >= 0);
                break;
              }
        ...
        var z = e ? e.displayName || e.name : "", X = z ? sr(z) : "";
        return typeof e == "function" && cr.set(e, X), X;
      }
      function Ct(e, r, a) {
        return Xr(e, !1);
      }
      ...
      function Ot(e, r, a, o, s) {
        {
          ...
          for (var p in e)
            if (m(e, p)) {
              ...
              b && !(b instanceof Error) && (fr(s), h("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", a, p, typeof b), fr(null)), b instanceof Error && !(b.message in Jr) && (Jr[b.message] = !0, fr(s), h("Failed %s type: %s", a, b.message), fr(null));
            }
        }
      }
      function Ye(e) {
...
Check the top-level render call using <` + a + ">.");
      ...
      function rt(e, r) {
        if (!(!e._store || e._store.validated || e.key != null)) {
          ...
          if (!et[a]) {
            et[a] = !0;
            var o = "";
            e && e._owner && e._owner !== re.current && (o = " It was passed a child from " + ve(e._owner.type) + "."), Ye(e), h('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', a, o), Ye(null);
          }
        }
      }
      function tt(e, r) {
      ...
      function at(e, r, a) {
        ...
        if (!o) {
          ...
          m ? s += m : s += Zr();
          var p;
          e === null ? p = "null" : $e(e) ? p = "array" : e !== void 0 && e.$$typeof === i ? (p = "<" + (ve(e.type) || "Unknown") + " />", s = " Did you accidentally export a JSX literal instead of a component?") : p = typeof e, h("React.createElement: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", p, s);
        }
      ...
      function Ft(e) {
        {
          var r = Ue;
          Ue++, K.current === null && (K.current = []);
          var a = K.isBatchingLegacy, o;
          try {
            if (K.isBatchingLegacy = !0, o = e(), !a && K.didScheduleLegacyUpdate) {
              var s = K.current;
              s !== null && (K.didScheduleLegacyUpdate = !1, Mr(s));
            }
          } catch (z) {
            throw pr(r), z;
          } finally {
            K.isBatchingLegacy = a;
          }
          if (o !== null && typeof o == "object" && typeof o.then == "function") {
            var m = o, p = !1, b = {
              then: function(z, X) {
                p = !0, m.then(function(ee) {
                  pr(r), Ue === 0 ? $r(ee, z, X) : z(ee);
                }, function(ee) {
                  pr(r), X(ee);
                });
              }
            ...
            if (pr(r), Ue === 0) {
              var $ = K.current;
              $ !== null && (Mr($), K.current = null);
              var U = {
                then: function(z, X) {
                  K.current === null ? (K.current = [], $r(j, z, X)) : z(j);
                }
              };
              return U;
            } else {
      ...
      function $r(e, r, a) {
        {
          ...
          if (o !== null)
            try {
              Mr(o), It(function() {
                o.length === 0 ? (K.current = null, r(e)) : $r(e, r, a);
              });
            } catch (s) {
              a(s);
            }
      ...
      v.Children = Wt, v.Component = S, v.Fragment = y, v.Profiler = R, v.PureComponent = J, v.StrictMode = T, v.Suspense = L, v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Q, v.cloneElement = Lt, v.createContext = ir, v.createElement = $t, v.createFactory = Mt, v.createRef = gr, v.forwardRef = xr, v.isValidElement = Ee, v.lazy = jr, v.memo = f, v.startTransition = At, v.unstable_act = Ft, v.useCallback = oe, v.useContext = x, v.useDebugValue = fe, v.useDeferredValue = gt, v.useEffect = Z, v.useId = bt, v.useImperativeHandle = ur, v.useInsertionEffect = B, v.useLayoutEffect = q, v.useMemo = we, v.useReducer = P, v.useRef = C, v.useState = I, v.useSyncExternalStore = _t, v.useTransition = mt, v.version = l, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
...
function Gt() {
  if (pt)
    return Ge;
  pt = 1;
  var k = mr.exports, v = Symbol.for("react.element"), l = Symbol.for("react.fragment"), i = Object.prototype.hasOwnProperty, w = k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, y = { key: !0, ref: !0, __self: !0, __source: !0 };
  function T(R, _, g) {
    var N, L = {}, H = null, G = null;
    g !== void 0 && (H = "" + g), _.key !== void 0 && (H = "" + _.key), _.ref !== void 0 && (G = _.ref);
    for (N in _)
      i.call(_, N) && !y.hasOwnProperty(N) && (L[N] = _[N]);
    if (R && R.defaultProps)
      for (N in _ = R.defaultProps, _)
        L[N] === void 0 && (L[N] = _[N]);
    return { $$typeof: v, type: R, key: H, ref: G, props: L, _owner: w.current };
  }
  return Ge.Fragment = l, Ge.jsx = T, Ge.jsxs = T, Ge;
}
var Ke = {};
/**
 * @license React
...
function Kt() {
  return vt || (vt = 1, process.env.NODE_ENV !== "production" && function() {
    var k = mr.exports, v = Symbol.for("react.element"), l = Symbol.for("react.portal"), i = Symbol.for("react.fragment"), w = Symbol.for("react.strict_mode"), y = Symbol.for("react.profiler"), T = Symbol.for("react.provider"), R = Symbol.for("react.context"), _ = Symbol.for("react.forward_ref"), g = Symbol.for("react.suspense"), N = Symbol.for("react.suspense_list"), L = Symbol.for("react.memo"), H = Symbol.for("react.lazy"), G = Symbol.for("react.offscreen"), ie = Symbol.iterator, ge = "@@iterator";
    function ne(t) {
    ...
    var se = !1, K = !1, re = !1, de = !1, he = !1, Ce;
    Ce = Symbol.for("react.module.reference");
    function Te(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === i || t === y || he || t === w || t === g || t === N || de || t === G || se || K || re || typeof t == "object" && t !== null && (t.$$typeof === H || t.$$typeof === L || t.$$typeof === T || t.$$typeof === R || t.$$typeof === _ || t.$$typeof === Ce || t.getModuleId !== void 0));
    }
    function Ve(t, u, f) {
      var d = t.displayName;
      if (d)
    ...
    var ae = Object.assign, Q = 0, le, h, pe, Se, n, c, E;
    function D() {
    }
    ...
    function S() {
      {
        if (Q === 0) {
          le = console.log, h = console.info, pe = console.warn, Se = console.error, n = console.group, c = console.groupCollapsed, E = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: D,
...
` + C[B].replace(" at new ", " at ");
        ...
        J = !1, W.current = I, M(), Error.prepareStackTrace = x;
      }
      var we = t ? t.displayName || t.name : "", ur = we ? A(we) : "";
      return typeof t == "function" && be.set(t, ur), ur;
    }
    function $e(t, u, f) {
      return Xe(t, !1);
    }
    ...
    var Pe = Object.prototype.hasOwnProperty, ke = {}, Je = ue.ReactDebugCurrentFrame;
    function je(t) {
      if (t) {
    ...
    function Be(t) {
      if (Ze(t))
        return Y("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Qe(t)), We(t);
    }
    ...
    function Tr(t, u, f, d, x) {
      {
        ...
        f !== void 0 && (Be(f), C = "" + f), Rr(u) && (Be(u.key), C = "" + u.key), Er(u) && (Z = u.ref, wr(u, x));
        for (I in u)
    ...
    var Ne = ue.ReactCurrentOwner, nr = ue.ReactDebugCurrentFrame;
    function ye(t) {
      if (t) {
        var u = t._owner, f = Le(t.type, t._source, u ? u.type : null);
...
Check the top-level render call using <` + f + ">.");
    ...
    function or(t, u) {
      {
        ...
        ar[f] = !0;
        var d = "";
        t && t._owner && t._owner !== Ne.current && (d = " It was passed a child from " + te(t._owner.type) + "."), ye(t), Y('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', f, d), ye(null);
      }
    }
    function ir(t, u) {
      {
    ...
    function ze(t) {
      {
        for (var u = Object.keys(t.props), f = 0; f < u.length; f++) {
          var d = u[f];
          if (d !== "children" && d !== "key") {
            ye(t), Y("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", d), ye(null);
            break;
          }
        }
        t.ref !== null && (ye(t), Y("Invalid attribute `ref` supplied to `React.Fragment`."), ye(null));
      }
    }
    function He(t, u, f, d, x, I) {
      {
        var P = Te(t);
        if (!P) {
          var C = "";
    ...
    var jr = kr, xr = Pr;
    Ke.Fragment = i, Ke.jsx = jr, Ke.jsxs = xr;
  }()), Ke;
}
(function(k) {
  process.env.NODE_ENV === "production" ? k.exports = Gt() : k.exports = Kt();
})(Yr);
const me = Yr.exports.jsx, Xt = Yr.exports.jsxs;
var Jt = ["u", "d", "l", "r", "lu", "ru", "rd", "ld"], ht = 50, yt = 50, Qt = function(k) {
  ...
  function v(l) {
    ...
    return Object.defineProperty(i, "isMouseDown", {
      ...
      value: function(w, y) {
        switch (i.dragDirection) {
          ...
          case "d":
            ...
            break;
          case "lu":
            i.extendToLeft(w), i.extendToUp(y);
            break;
          case "ru":
            i.extendToRight(w), i.extendToUp(y);
            break;
          case "ld":
            i.extendToLeft(w), i.extendToDown(y);
            break;
          case "rd":
            i.extendToRight(w), i.extendToDown(y);
        }
        var T = {
      ...
      value: function(w) {
        if (i.element) {
          ...
          if (y < 0)
            ...
            var T = i.props.minWidth, R = T === void 0 ? ht : T, _ = i.width - w;
            _ < R ? _ = R : i.element.parentElement.style.left = "".concat(y, "px"), i.element.parentElement.style.width = "".concat(_, "px");
          }
        }
      }
      ...
      value: function(w) {
        if (i.element) {
          var y = i.width + w, T = document.getElementById(i.props.container);
          T && i.currentX + y >= T.clientWidth && (y = T.clientWidth - i.currentX);
          var R = i.props.minWidth, _ = R === void 0 ? ht : R;
      ...
      value: function(w) {
        if (i.element) {
          ...
          if (y <= 0)
            ...
            var T = i.height - w, R = i.props.minHeight, _ = R === void 0 ? yt : R;
      ...
      value: function(w) {
        if (i.element) {
          var y = i.height + w, T = document.getElementById(i.props.container);
          T && y + i.currentY > T.clientHeight && (y = T.clientHeight - i.currentY);
          var R = i.props.minHeight, _ = R === void 0 ? yt : R;
  ...
  return Object.defineProperty(v.prototype, "componentDidMount", {
    ...
    value: function() {
      ...
      window.addEventListener("mousedown", function(i) {
        l.startX = i.clientX, l.startY = i.clientY, i.target == l.element ? (l.isMouseDown = !0, l.element && (l.currentX = l.element.parentElement.offsetLeft, l.currentY = l.element.parentElement.offsetTop)) : Jt.includes(i.target.id) && (l.isMouseDown = !0, l.dragDirection = i.target.id);
      }), window.addEventListener("mousemove", function(i) {
        var w = i.clientX - l.startX, y = i.clientY - l.startY;
        if (l.isMouseDown) {
          if (l.dragDirection)
            l.transform(w, y);
          else if (l.element) {
            var T = l.currentX + w, R = l.currentY + y, _ = document.getElementById(l.props.container);
            T < 0 && (T = 0), R < 0 && (R = 0), _ && (T > _.clientWidth - l.width && (T = _.clientWidth - l.width), R > _.clientHeight - l.height && (R = _.clientHeight - l.height)), l.element.parentElement.style.left = "".concat(T, "px"), l.element.parentElement.style.top = "".concat(R, "px");
          }
    ...
    writable: !0,
    value: function() {
      var l = this, i = this.props, w = i.anchorBorderColor, y = w === void 0 ? "#666666" : w, T = i.anchorBorderWidth, R = T === void 0 ? 1 : T, _ = i.anchorSize, g = _ === void 0 ? 6 : _, N = i.anchorColor, L = N === void 0 ? "#ffffff" : N, H = "solid ".concat(R, "px ").concat(y), G = this.props;
      G.x, G.y, G.width, G.height;
      var ie = G.background, ge = ie === void 0 ? "rgba(243,255,226,.8)" : ie, ne = G.containerStyle, ue = ne === void 0 ? {} : ne, Y = {
        background: ge,
        border: "solid 1px #000000"
      }, ce = Object.assign({}, Y, ue);
      return ce.position = "absolute", me("div", yr({
        style: ce
      }, {
        children: Xt("div", yr({
          style: {
